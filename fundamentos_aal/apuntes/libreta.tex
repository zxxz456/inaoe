...
\begin{pendiente}
    Las dos preguntas que quedaron abiertas sobre n-gramas:
    \begin{itemize}
        \item Cómo reducir la dimensionalidad?
        \item Cómo seleccionar los n-gramas útiles?
    \end{itemize}
\end{pendiente}
...
\begin{pendiente}
    Queda pendiente cómo se representa y cómo se desambigua un
    sentido, que es donde sigue la clase.
\end{pendiente}
