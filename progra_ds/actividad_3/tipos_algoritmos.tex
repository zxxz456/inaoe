...
\begin{abstract}
    ...
    de la Computación) recorre los tipos de algoritmos más comunes. Tras unas 
    notas sobre la noción de algoritmo y la medición de su eficiencia mediante 
    notación asintótica, se abordan las familias clásicas: determinísticos y no
